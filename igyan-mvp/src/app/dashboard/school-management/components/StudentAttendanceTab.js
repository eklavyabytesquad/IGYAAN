...
export default function StudentAttendanceTab({ schoolId, session, classes, userId }) {
		...
		<div className="space-y-6">
			<div className="flex items-center justify-between">
				<div>
					...
					<p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">Mark and review daily attendance</p>
				</div>
